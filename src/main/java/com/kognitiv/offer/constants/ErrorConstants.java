...
public class ErrorConstants {
	...
	public static final String OFFER_NOT_FOUND = "The offer you requested is currently not present";
	public static final String OFFER_NOT_SAVED = "The offer you posted was unable to be saved....  Please try again later";
	public static final String OFFER_EMPTY = "The given object is empty.. Input proper message";
